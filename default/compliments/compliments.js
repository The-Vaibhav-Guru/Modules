...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Hello There!"],
			morning: ["May the Force be with you", "Enjoy your day!", "How was your sleep?"],
			afternoon: ["Afternoon, all. Lovely day for it", "What's up, Doc?", "Looking good today!"],
			evening: ["Good evening, Mr. Bond", "You look nice!", "Good ebeing"],
